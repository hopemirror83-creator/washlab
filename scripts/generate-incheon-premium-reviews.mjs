...
const DEFAULT_VERTEX_PROJECT_ID = 'hotel-509411';
const DEFAULT_VERTEX_LOCATION = 'global';
const DEFAULT_VERTEX_SERVICE_ACCOUNT_FILE = 'C:\\내문서\\애드버코더\\hotel-509411-fc6fbf080bfc.json';
...
- 광고성 과장 표현은 사용하지 않고, 실제 선택에 도움이 되는 말로 씁니다.
- "최고", "완벽", "최적", "탁월", "명소", "성지", "입소문", "든든한", "즐거움"처럼 홍보성으로 읽히는 표현은 쓰지 않습니다.
- 후기 수가 적으므로 "많은 이용자", "대부분", "꾸준히 추천", "재방문을 결심"처럼 규모나 빈도를 확대해 단정하지 않습니다.
- 참고 글의 제목과 설명에서 확인되지 않는 시설, 수압, 요금, 운영시간, 혜택은 만들어내지 않습니다.
- 업체가 직접 작성한 글은 시설과 작업 사례를 확인하는 참고자료로만 쓰고, 방문자 만족 의견처럼 표현하지 않습니다.
...
필드:
{
  ...
  "conclusionSection": "주변 업체와 비교해 보라는 중립적인 마무리 1~2문장. 방문을 권유하거나 홍보하지 않음"
}
